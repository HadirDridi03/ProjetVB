...
Partial Class adminForm
    ...
    Private Sub InitializeComponent()
        ...
        ' txtNumVol
        ' 
        txtNumVol.Location = New Point(260, 74)
        ...
        ' dtp
        ' 
        dtp.Location = New Point(224, 182)
        dtp.Name = "dtp"
        ...
        ' nudPlaceDisp
        ' 
        nudPlaceDisp.Location = New Point(260, 247)
        ...
        dgvVols.Location = New Point(45, 484)
        ...
        ' btnAjouter
        ' 
        btnAjouter.BackColor = Color.IndianRed
        btnAjouter.Font = New Font("Javanese Text", 13.8F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        btnAjouter.Location = New Point(54, 373)
        ...
        Label2.Name = "Label2"
        Label2.Size = New Size(157, 52)
        Label2.TabIndex = 6
        Label2.Text = "Destination:"
        ' 
        ' txtDest
        ' 
        txtDest.Location = New Point(260, 132)
        ...
        label.Location = New Point(23, 298)
        label.Name = "label"
        label.Size = New Size(75, 52)
        label.TabIndex = 9
        label.Text = "Prix:"
        ' 
        ' nudPrix
        ' 
        nudPrix.Location = New Point(260, 298)
        ...
        ' btnModifier
        ' 
        btnModifier.BackColor = Color.IndianRed
        btnModifier.Font = New Font("Javanese Text", 13.8F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        btnModifier.Location = New Point(297, 373)
        btnModifier.Name = "btnModifier"
        btnModifier.Size = New Size(190, 47)
        ...
        btnSupprimer.Font = New Font("Javanese Text", 13.8F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        btnSupprimer.Location = New Point(532, 373)
        btnSupprimer.Name = "btnSupprimer"
        btnSupprimer.Size = New Size(183, 47)
        ...
        btnConnexion.Font = New Font("Javanese Text", 16.2F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        btnConnexion.ForeColor = Color.IndianRed
        btnConnexion.Location = New Point(155, 632)
        ...
        Label4.Location = New Point(260, -2)
        Label4.Name = "Label4"
        Label4.Size = New Size(287, 78)
        Label4.TabIndex = 14
        Label4.Text = "Gestion des vols"
        ' 
        ' Label5
        ' 
        ...
        Label6.Location = New Point(23, 429)
        Label6.Name = "Label6"
        ...
        BackgroundImage = My.Resources.Resources._9ba7a6f8ff3d337564ee1fe7d97c74b11
